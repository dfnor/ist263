...
const displayPLayers = (filteredPlayers) => {
    ...
    filteredPlayers.forEach( (player) => {
        ...
        const { name, slug, number, position, year, hometown, highschool, height, weight } = player;
        ...
        // 3. Append the children to the parent
        ...
        playerSecondaryMeta.innerHTML = `${city}, ${state ? state : country ? country : ''}
        <br />${highschool.name}`;
        ...
        playerTertiaryMeta.innerHTML = `${getFormattedHeight(height)}<br /
        >${weight} lbs.`;
        ...
        playerArticle.append(playerCTA);
